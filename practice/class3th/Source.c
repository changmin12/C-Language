...
#pragma region 언더플로우
	...
	// 최솟값을 엄어간 만큼 다시 계산합니다. 
#pragma endregion

#pragma region 실수를 저장하는 방법

	// 부동 소수점이란?
	// 소수정의 위치를 고정하지 않고, 소수점의 위치를 나타내는 방법입니다.
	//float attack = 6.25f;
	...
	// 10진수 실수 부분을 1.0이 될 때까지 겨속 2로 곱한 다음
	// 곱한 결과의 정수 부분을 위에서 아래로 순서대로 정렬합니다.
#pragma endregion

#pragma region 조건문
	// 어떤 조건이 주어질때 해당 조건에 따라 동작을
	// 수행하도록 실행하는 명령문입니다.
  ...
  // 어떤 결과에 따라 그 결과부터 실행되는 명령문입니다.
   ...
   //   // 특정한 지점에서 분기를 탈출하는 제어문입니다.
	  ...
	  //default: printf("잘못된 값이 들어왔습니다.\n");
		 ...
		 // // 나머지 밑에 있는 case 문까지 계속 실행시키다가 종료합나다.
   //   }
	   // switch문의 경우 조건에 해당라는 값에 따라 조건의
	   // 위치로 이동합니다
